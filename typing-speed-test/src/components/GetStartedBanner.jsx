      ...
      <div className="flex w-full flex-col justify-between border-b border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700 md:flex-row">
        <div className="mb-4 md:mb-0 md:mr-4">
          ...
          <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            significant impact on your writing skills. The TypingWorld is made
            to reinforce continuous learning of how to type. We track your
            progress so you can see how your typing speed and accuracy increase
            over time. Regular activities are a critical factor in achieving
